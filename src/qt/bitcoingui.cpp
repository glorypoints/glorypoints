...
{
    resize(850, 550);
    setWindowTitle(tr("GlorylovePoints") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a GlorylovePoints address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About GlorylovePoints"), this);
    aboutAction->setToolTip(tr("Show information about GlorylovePoints"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for GlorylovePoints"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("GlorylovePoints client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("GlorylovePoints client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GlorylovePoints network.", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid GlorylovePoints address or malformed URI parameters."));
    }
